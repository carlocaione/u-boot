...
struct meson_mmc_global_regs {
	...
	volatile uint32_t gcalout;
	volatile uint32_t reserved_14[11];
	volatile uint32_t gstart;
	volatile uint32_t gcfg;
	volatile uint32_t gstatus;
	volatile uint32_t girq_en;
	volatile uint32_t gcmd_cfg;
	volatile uint32_t gcmd_arg;
	volatile uint32_t gcmd_dat;
	volatile uint32_t gcmd_rsp0;
	volatile uint32_t gcmd_rsp1;
	volatile uint32_t gcmd_rsp2;
	volatile uint32_t gcmd_rsp3;
	volatile uint32_t reserved_6c;
	volatile uint32_t gcurr_cfg;
	volatile uint32_t gcurr_arg;
	volatile uint32_t gcurr_dat;
	volatile uint32_t gcurr_rsp;
	volatile uint32_t gnext_cfg;
	volatile uint32_t gnext_arg;
	volatile uint32_t gnext_dat;
	volatile uint32_t gnext_rsp;
	volatile uint32_t grxd;
	volatile uint32_t gtxd;
	volatile uint32_t reserved_98[90];
	volatile uint32_t gdesc[128];
	volatile uint32_t gping[128];
